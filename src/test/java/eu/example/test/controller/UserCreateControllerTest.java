package eu.example.test.controller;
...
import eu.example.controller.UserCreateController;
import eu.example.domain.User;
import eu.example.domain.UserCreateForm;
import eu.example.service.UserService;
import eu.example.service.exception.UserAlreadyExistsException;
import eu.example.validator.UserCreateFormPasswordValidator;
